...
abstract class HexvoidModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexvoidModDependenciesExtension>("hexvoidModDependencies")
