...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexvoid.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexvoid-common-common-refmap.json
        // fixed:   hexvoid-common.refmap.json
