...
typealias RegistrarEntry<T> = HexvoidRegistrar<T>.Entry<out T>

abstract class HexvoidRegistrar<T : Any>(
    ...
    fun <V : T> register(name: String, builder: () -> V): Entry<V> = register(Hexvoid.id(name), builder)
